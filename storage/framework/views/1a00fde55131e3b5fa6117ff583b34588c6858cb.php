      ...
      <ul class="nav-menus">
        ...
        <li class="cart-nav onhover-dropdown">
          ...
          <ul class="cart-dropdown onhover-show-div">
            <li>
              <h6 class="mb-0 f-20">Shopping Bag</h6>
            ...
            <li>
              <div class="total">
                <h6 class="mb-2 mt-0 text-muted">Order Total : <span class="f-right f-20">$<?php echo e(\Cart::getTotal()); ?></span></h6>
              </div>
            </li>
...
<?php /**PATH D:\Programacion\laragon\www\CubaStarter\resources\views/layouts/simple/header.blade.php ENDPATH**/ ?>