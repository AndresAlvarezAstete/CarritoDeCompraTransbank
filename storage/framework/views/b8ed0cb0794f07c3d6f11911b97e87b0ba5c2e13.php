              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list">
                    <label class="badge badge-success">3</label><a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/dashboard' ? 'active' : ''); ?>" href="#"><i data-feather="home"></i><span class="lan-3"><?php echo e(trans('lang.Dashboards')); ?></span>
                    ...
                    <ul class="sidebar-submenu" style="display: <?php echo e(request()->route()->getPrefix() == '/dashboard' ? 'block;' : 'none;'); ?>">
                      <li><a class="lan-4 <?php echo e(Route::currentRouteName()=='index' ? 'active' : ''); ?>" href="<?php echo e(route('index')); ?>"><?php echo e(trans('lang.Default')); ?></a></li>
                                ...
                                <li><a class="lan-6 <?php echo e(Route::currentRouteName()=='shop' ? 'active' : ''); ?>" href="<?php echo e(route('shop')); ?>"><?php echo e(trans('Products')); ?></a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
...
</html><?php /**PATH D:\Programacion\laragon\www\CubaStarter\resources\views/page-layout/box-layout.blade.php ENDPATH**/ ?>